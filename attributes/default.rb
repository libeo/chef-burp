...
# 1.4-master 2014-04-22
default['burp']['git_ref'] = '94ec12cddf231be94eaaf428d9a8b86031f51a25'
# Set to true to force a one-time reinstall
default['burp']['force_install'] = false
...
# e-mail settings
default['burp']['email_all_from'] = '"=?ISO-8859-1?Q?Sauvegarde=20Lib=E9o?=" <backupmaster@libeo.com>' # rubocop:disable all
# A string is enough for a single recipient.
default['burp']['email_all_to'] = ''
default['burp']['email_failure_from'] = '"=?ISO-8859-1?Q?Sauvegarde=20Lib=E9o?=" <backupmaster@libeo.com>' # rubocop:disable all
